  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 mb-6">
        {["Alle", "Entwurf", "Aktiv", "Pausiert", "Abgeschlossen"].map((tab, i) => (
          <button
            key={tab}
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-16 text-center">
        ...
        <h2 className="text-xl font-black text-blueprint mb-2">Noch keine Inserate</h2>
        <p className="text-slate-500 max-w-md mx-auto mb-8">
          Erstellen Sie zuerst eine Immobilie, dann generieren Sie ein KI-gestütztes Inserat mit Preisstrategien, Compliance-Prüfung und Portal-Veröffentlichung.
        </p>
